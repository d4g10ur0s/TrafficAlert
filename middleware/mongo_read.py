...
# set up the query
gt = dt.datetime(year=2024, month=6, day=26, hour=int(sys.argv[1]), minute=int(sys.argv[2]), second=int(sys.argv[3]), tzinfo=dt.timezone.utc)
lt = dt.datetime(year=2024, month=6, day=26, hour=int(sys.argv[4]), minute=int(sys.argv[5]), second=int(sys.argv[6]), tzinfo=dt.timezone.utc)
gt = gt.isoformat()
lt = lt.isoformat()
